class k6_console {
  ...
  constructor( P = {} ) {
    ...
    window[ this.prefix + 'CD'   ] = true                                                                                                                                                  // Config           Debug
    window[ this.prefix + 'FCD'  ] = ( ... args ) => { console.debug   ( `%c${this.header}`, 'color: white; background-color: magenta;', ... args ); this.FM( 'white', 'magenta', args ) } // Function Console Debug
    window[ this.prefix + 'FCE'  ] = ( ... args ) => { console.error   ( `%c${this.header}`, 'color: white; background-color: red    ;', ... args ); this.FM( 'white', 'red'    , args ) } // Function Console Error
    window[ this.prefix + 'FCW'  ] = ( ... args ) => { console.warn    ( `%c${this.header}`, 'color: black; background-color: yellow ;', ... args ); this.FM( 'black', 'yellow' , args ) } // Function Console Warn
    window[ this.prefix + 'FCG'  ] = ( ... args ) => { console.group   ( `%c${this.header}`, 'color: white; background-color: grey   ;', ... args ); this.FM( 'white', 'grey'   , args ) } // Function Console Group
    window[ this.prefix + 'FCGE' ] = ( ... args ) => { console.groupEnd(                                                                          )                                      } // Function Console Group End
    window[ this.prefix + 'FCT'  ] = ( ... args ) => { console.trace   ( `%c${this.header}`, 'color: white; background-color: blue   ;', ... args ); this.FM( 'white', 'blue'   , args ) } // Function Console Trace
    window[ this.prefix + 'FCI'  ] = ( ... args ) => { console.info    ( `%c${this.header}`, 'color: black; background-color: cyan   ;', ... args ); this.FM( 'black', 'cyan'   , args ) } // Function Console Info
    window[ this.prefix + 'FCL'  ] = ( ... args ) => { console.log     ( `%c${this.header}`, 'color: white; background-color: green  ;', ... args ); this.FM( 'white', 'green'  , args ) } // Function Console Log
    window[ this.prefix + 'FCLR' ] = ( object, mobile = false ) => {                                                                                                                       // Function Console Log Recursive
